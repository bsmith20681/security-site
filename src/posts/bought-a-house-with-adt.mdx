...
In order to get the system turned on, you will need to call in to activate the service. When you call in, you will speak to a sales rep over the phone that can set up your account and go over pricing. Their monthly price is usually around \$45 per month.
...
If you want to upgrade equipment, you can do that when you call in to activate the system. ADT has been around for a long time, so chances are that you have older equipment.
